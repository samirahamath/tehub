...
<body>
  ...
  <main id="main">
      ...
      <div class="container container--wide">
        <div class="hero-grid">
          ...
          <div class="hero-media">
            <video autoplay loop muted playsinline aria-label="A developer looking at lines of code and cloud deployment logs on a modern dashboard.">
    ...
    <section id="process">
      <div class="container container--wide">
        ...
        <div style="margin: var(--space-5) 0 var(--space-6) 0; border-radius: var(--radius-lg, 16px); overflow: hidden; border: 1px solid var(--ink-line); aspect-ratio: 16 / 9; max-height: 450px; width: 100%;">
          <video autoplay loop muted playsinline aria-label="Our agile development process" style="width: 100%; height: 100%; object-fit: cover; display: block;">
  ...
  <nav class="mobile-bottom-nav" aria-label="Mobile Navigation">
    ...
    <a href="services.php" class="mobile-bottom-nav__item" aria-current="page">
